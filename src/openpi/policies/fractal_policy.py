...
class FractalInputs(transforms.DataTransformFn):
    ...
    def __call__(self, data: dict) -> dict:
        ...
        # For pi0-FAST, we don't pad the state. For Fractal, we don't need to differentiate
...
class FractalOutputs(transforms.DataTransformFn):
    ...
    def __call__(self, data: dict) -> dict:
        ...
        # For Fractal, we only return the first 7 actions (since the rest is padding).
